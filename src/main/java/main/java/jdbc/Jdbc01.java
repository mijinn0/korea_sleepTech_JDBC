...
/*
    ...
    1) ctrl + , (설정)
        >> 추가 사항(테마, 글꼴 등) 확인 가능
        (설정 > 에디터 > 일반 > 코드 완성 > 대/소문자 일치 끄기)
        (설정 > 에디터 > 일반 > 코드 완성 > 코드 입력 시 제안 표시 끄기)
        (설정 > 에디터 > 일반 > 인라인 완성 > 로컬 Full line 완성 제안 활성화 끄기)
...
* - Java에서 표준화된 SQL을 사용하여 DBMS와의 유연성을 확보 (유지보수, 효율성)
*      >> 통합된 표준 인터페이스 제공
*
* 3) JDBC 학습 목적
